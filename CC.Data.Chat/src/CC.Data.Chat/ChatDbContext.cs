...
using CC.Data.Chat.Models.Entities;

namespace CC.Data.Chat
{
    public class ChatDbContext : DbContext
    {
        ...
        )
        {
            ...
            var testChats = new List<Models.Entities.Chat>()
            {
                new Models.Entities.Chat()
                {
                    Id = _Ids["ChatId"],
                    Name = "Test Chat",
            ...
            modelBuilder.Entity<Models.Entities.Chat>()
                .HasData(testChats);
        ...
        )
        {
            ...
            var chatModelType = typeof(Models.Entities.Chat);
